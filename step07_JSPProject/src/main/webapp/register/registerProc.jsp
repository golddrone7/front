...
<%
	...
	String post3=request.getParameter("mem_detailaddr");
	String post2=request.getParameter("mem_roadaddr");
	//response.getWriter().append(post1);
	ob.setMem_addr(post2+" " +post3);
%>
