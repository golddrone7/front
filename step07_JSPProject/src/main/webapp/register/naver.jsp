        ...
        <div class="content">
            <div class="login_wrap">
                ...
                <form id="frmNIDLogin" name="frmNIDLogin" target="_top" AUTOCOMPLETE="off"
                    ...
                    <input type="hidden" name="dynamicKey" id="dynamicKey" value="ilhh7cP0MlFVfMqdmqFfVzr35Y7v-k13nWN5ctp1vvlUauDD7ENMSsBpGPSq49ZRb7Psn3QheloYVTbQkti8HNw6yZKE0K2YWArA1B99CYw">
